            ...
            <div class="row">
              <div class="col-sm-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form id="actionForm" action="{{route('assigned-list.update', $emp->id)}}" method="post" enctype="multipart/form-data">
                      @csrf @method('put')
                      <!-- Category Selection -->
                       ...
                       <!-- Initiatives and Sub-Initiatives -->
                        ...
                        <div class="col-md-6 mt-3">
                          ...
                          <select class="form-select" required>
                            <option value="{{$emp->id}}" selected>{{$emp->emp_name}} ({{$emp->designation}})</option>
                          </select>
                        </div>
                        <div class="col-md-6 mt-3">
                          ...
                          <select name="reporting_officer_id" class="form-select" id="ro" required>
                            ...
                            <option value="{{$entry->id}}" {{$emp->reporting_officer_id == $entry->id ? 'selected' : ''}}>{{$entry->emp_name}} ({{$entry->designation}})</option>
                            @endforeach
                          </select>
                        </div>

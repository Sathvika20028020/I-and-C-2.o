                  ...
                  <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        <form id="excelUploadForm" action="{{route('admin.exelimport.importtwo')}}" method="POST" enctype="multipart/form-data" novalidate>
                            @csrf
    ...
    var table = $('#dashboardtwo').DataTable({
        ...
        columns: [
            ...
            { data: 'total' },
            {
                ...
                searchable: false,
                render: function (data) {
                    return `<a href="/integrateddata/users/dashboardtwoview/${data}" class="btn btn-sm btn-primary">View</a>`;
                }
            }
            //  {
            //     data: 'id',
...
<script>
  $("#exportSelected").on("click", function () {
            ...
            // Stop loader after 8 seconds (8000 ms)
            setTimeout(function () {
                $("#loader").fadeOut();
            }, 8000);
        });

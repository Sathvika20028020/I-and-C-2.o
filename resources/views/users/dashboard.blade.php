            ...
            <div class="row">
              ...
              <div class="col-12 col-sm-6">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"> MSME</li>
                  <li class="breadcrumb-item active"> MSME Report</li>
                </ol>
              </div>
            </div>
          </div>
          <h3 class="text-center m-3">
    Karnataka State MSME Report  ({{ $fromDateFormatted }} - {{ $toDateFormatted }})
  </h3>
                ...
                <div class="d-flex flex-column align-items-end">
                    ...
                    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-content">
                            <form id="excelUploadForm" action="{{ route('exelimport.import') }}" method="POST" enctype="multipart/form-data" novalidate>
                            @csrf 
    ...
    var table = $('#usersTable').DataTable({
    ...
    
     {
        ...
        render: function(data, type, row, meta) {
            return `<a href="/users/view/${data}" class="btn btn-sm btn-primary">View</a>`;
        }
    }
    // {
    //     data: 'id',
...
<script>
    $(document).ready(function () {
        ...
        // ✅ Show loader when clicking export/import buttons (DataTables)
        $(document).on('click', '.buttons-excel, .buttons-csv, .buttons-pdf, .buttons-print', function () {
            $("#loader").fadeIn();

            // Hide loader after a short delay (adjust if needed)
            setTimeout(function () {
                $("#loader").fadeOut();
            }, 2000);
        });

        // ✅ Show loader when clicking any normal link that navigates away
    ...
    // ❌ REMOVE this — causes loader to stay stuck after downloads

...
<div class="card header-card shape-rounded" data-card-height="90">
    ...
    <div class="card-bg " data-src="images/pictures/20s.jpg"></div>
</div>

<div class="d-flex flex-column gap-2 mt-5 mb-3">
    <div class="card m-2" style="border-radius: 20px;">
        <div class="card-body">
            <form class="needs-validation" method="post" action="{{ route('pwa.leaves.store') }}"
                enctype="multipart/form-data" novalidate>
                @csrf
                <!-- Applicant Name -->
                <div class="mb-3">
                    <label class="form-label font-aneka fontsize">Applicant Name</label>
                ...
                <!-- Leave Type -->
                <div class="mb-3">
                    <label class="form-label font-aneka fontsize">Leave Type</label>
                ...
                <!-- Duration -->
                <div class="mb-3">
                    <label class="form-label font-aneka fontsize">Duration</label>
                ...
                <div class="mb-3" id="singleDateDiv">
                    <label class="form-label font-aneka fontsize">Date of Leave</label>
                ...
                <div class="mb-3 d-none" id="multipleDateDiv">
                    <label class="form-label font-aneka fontsize">Leave Dates</label>

                    <div class="row g-2">
                        <div class="col-md-6">
                            <label class="form-label font-aneka small fontsize">From Date</label>
                        ...
                        <div class="col-md-6">
                            <label class="form-label font-aneka small fontsize">To Date</label>
                ...
                <!-- Reason -->
                <div class="mb-3">
                    <label class="form-label font-aneka fontsize">Reason</label>
                    <textarea class="form-control fontsize2" style="border-radius: 5px !important;" rows="3"
                ...
                <!-- File -->
                <div class="mb-3">
                    <label class="form-label font-aneka fontsize">Attach File</label>
                    <input name="file" type="file" class="form-control" accept=".jpg,.jpeg,.png,.pdf">
                    <div class="invalid-feedback font-aneka">

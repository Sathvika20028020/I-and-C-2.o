<div id="footer-bar" class="footer-bar-5">
    ...
    <a href="{{ url('/pwa/leaves') }}"
       class="d-flex flex-column align-items-center {{ request()->is('pwa/leaves') ? 'active-nav' : '' }}">
        <i data-feather="calendar" data-feather-line="1" data-feather-size="21"
   ...
   class="d-flex flex-column align-items-center {{ request()->is('pwa/category') ? 'active-nav' : '' }}">
    <i data-feather="folder" data-feather-line="1" data-feather-size="21"  data-feather-color="dark-dark" data-feather-bg="green-fade-light"></i>
    <span>Assets</span>
</a>
    @endif
